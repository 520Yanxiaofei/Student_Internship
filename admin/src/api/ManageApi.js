...
/*删除主机*/
export async function ManageDelHost(params) {
	return request(`/host/del_host`, {
		method: 'POST',
		body: params
	});
}
...
/*告警同类型*/
export async function ManageAlarmRepact(params) {
	return request(`/alarm/show_repeat_alarm`, {
		method: 'POST',
		body: params
	});
}
